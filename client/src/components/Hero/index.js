        ...
        <div className="col-md-12">
          <Jumbotron fluid id="img-header">
              ...
              <map name="workmap">
                ...
                <area target="" alt="about" title="red" href="about" coords="152,400,61" shape="circle" />
                <area target="" alt="register" title="yellow" href="register" coords="390,173,42" shape="circle" />
